            ...
            <div class="w3-row-padding">
                <div class="w3-twothird s4">
                    ...
                    if(isset($_POST['purchase'])){
                        require('db.php');
                        $products = "DELETE FROM consoles WHERE id = '$id'";
                ...
                <div class="w3-third s4">
                    ...
                    <?php
                    require('db.php');
                    $products = "SELECT * FROM consoles WHERE id = '$id'";
                    $result = mysqli_query($con, $products);
                    ...
                    <div class="col-md-20 mt-3">
                        <div class="border p-2">
                            <h6><?= $row['Name']; ?></h6>
                            <h6><?= $row['GraphicsQuality']; ?></h6>
                            <h6><?= $row['CpuPerformance']; ?></h6>
                            <h6><?= "Ram: " . $row['Ram'] . "GB"; ?></h6>
                            <h6><?= $row['StorageSize'] . "GB " . $row['StorageType']; ?></h6>
