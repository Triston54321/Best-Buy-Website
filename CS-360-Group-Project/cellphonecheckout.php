...
<html>
<head>
    <title>Cell Phone Checkout</title>
    <meta charset="UTF-8" />
            ...
            <div class="w3-row-padding">
                <div class="w3-twothird s4">
                    ...
                    if(isset($_POST['purchase'])){
                        require('db.php');
                        $products = "DELETE FROM cellphones WHERE id = '$id'";
                ...
                <div class="w3-third s4">
                    ...
                    <?php
                    require('db.php');
                    $products = "SELECT * FROM cellphones WHERE id = '$id'";
                    $result = mysqli_query($con, $products);
                    ...
                    <div class="col-md-20 mt-3">
                        <div class="border p-2">
                            ...
                            <h6>
                                <?= "Screen Size: " . $row['ScreenSize']; ?>
                            </h6>
                            <h6>
                                <?= "Storage Size: " . $row['StorageSize']; ?>
                            </h6>GB
                            <h6>
                                <?= "RAM: " . $row['Ram']; ?>
                            </h6>
                            ...
                            <h6>
                                <?= "Wireless Tech: " . $row['WirelessTech']; ?>
                            </h6>
                            <h6>
                                <?= "Price: $" . $row['Price']; ?>
                            </h6>
