            ...
            <div class="w3-row-padding">
                <div class="w3-twothird s4">
                    ...
                    if(isset($_POST['purchase'])){
                        require('db.php');
                        $products = "DELETE FROM cameras WHERE id = '$id'";
                ...
                <div class="w3-third s4">
                    ...
                    <?php
                    require('db.php');
                    $products = "SELECT * FROM cameras WHERE id = '$id'";
                    $result = mysqli_query($con, $products);
                    ...
                    <div class="col-md-20 mt-3">
                        <div class="border p-2">
                            ...
                            <h6>
                                <?= "Max Aperature: " . $row['MaxAperture']; ?>
                            </h6>
                            <h6>
                                <?= "Video Resolution: " . $row['VideoResolution']; ?>
                            </h6>
                            <h6>
                                <?= "Price: $" . $row['Price']; ?>
                            </h6>
